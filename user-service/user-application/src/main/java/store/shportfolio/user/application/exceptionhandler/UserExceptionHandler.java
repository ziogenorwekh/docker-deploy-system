...
public class UserExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleServiceUnavailableException(CustomServiceUnavailableException ex, WebRequest request) {
        ExceptionResponse exceptionResponse = ExceptionResponse
                .builder()
                .error(ex.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<Object> handleUserNotOwnerException(UserNotOwnerException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse
                .builder()
                .error(ex.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    public ResponseEntity<Object> handleCustomBadCredentialsException(CustomBadCredentialsException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse
                .builder()
                .error(ex.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    @ExceptionHandler(AlreadyMailSendException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<ExceptionResponse> handleAlreadyMailSendException(AlreadyMailSendException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse
                .builder()
                .error(ex.getMessage())
                .timestamp(LocalDateTime.now())
