...
import store.shportfolio.database.infrastructure.adapter.DatabaseRepositoryImpl;
...
@SpringBootTest(useMainMethod = SpringBootTest.UseMainMethod.NEVER, classes = {
        DatabaseRepositoryImpl.class, JpaConfiguration.class, JdbcConfiguration.class,
...
public class DatabaseRepositoryImplTest {
    ...
    public void testCreateDatabase() {
        ...
        Database database = Database.createDatabase(userGlobal, new DatabaseCreateCommand("databasepwd1"));
